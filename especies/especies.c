...
int  e[N+1],  w, t, k_m; 
double  ben[N+1],p;
double ro1,ro2,ro3, ro_min, ro_max, delta_ro, c_media;      //media (sobre Niter realizaciones) de cooperadores (sin discriminar)
...
int main()
{
    ...
    printf("ro1=%.2lf   ro2=%.2lf   ro3=%.2lf\n",ro1,ro2,ro3);
	...
	sprintf(nombre2,"Evol_temp_b%.2lf_bprima%.2lf_alfa%.1lf_ro1%.2lf_ro2%.2lf_ro3%.2lf_N%d_%diter.dat",b,R_,alfa,ro1,ro2,ro3,N,Niter);    
	...
	sprintf(nombre,"Concentr_vs_c.i._b%.2lf_bprima%.2lf_alfa%.1lf_ro1%.2lf_ro2%.2lf_ro3%.2lf_N%d_%diter.dat",b,R_,alfa,ro1,ro2,ro3,N,Niter);    
