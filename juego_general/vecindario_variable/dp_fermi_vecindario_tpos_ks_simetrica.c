...
# define ratio_min    4.0    //cociente   beneficio/coste  (siempre >1)
# define ratio_max    4.001
# define delta_ratio  0.5
...
int main()
{
    ...
    printf("\n\n\nPrograma PD con vecindad variable\n\n"); 
    ...
    sprintf(nombre3,"v__C_med_ratio%.2lf-%.2lf_alfa%.1lf_selecc%.2lf_kstar%d_N%d_%diter.dat",ratio_min,ratio_max,alfa,seleccion,KSTAR,N,Niter); 
	...
	sprintf(nombre2,"v__Evoluc_coop_ratio%.2lf_alfa%.1lf_selecc%.2lf_kstar%d_N%d_%diter.dat",ratio,alfa,seleccion,KSTAR,N,Niter); 
...
//printf("tpo:%d\n",tpo);  
	...
	//printf("   fin de las comparaciones\n");  
