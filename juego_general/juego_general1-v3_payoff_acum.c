...
#define nb 30    //numero de valores de b


#define rondas 10      //durante las cuales se acumula el payoff
...
# define K_MAX   800          //para el tamaño de C[N][K_MAX]     ojo pq depende de N en SF!!!
 ...
 for(n=1;n<=jugadas;n++)            //pasos de tiempo
   {
     ...
     for(rr=1;rr<=rondas;rr++)   //juego rondas seguidas acumulando payoff
       {	 	 
