...
# define ventana 5000
# define Nventanas 5000            //para asegurarme de que no para antes de llegar al equilibrio
...
double r,v,dobleprec;                                  //para guardar los aleatorios
...
double c_instant[ventana+1];                 //para determinar el equilibrio
int I, II,a;
double s1,s2,s3,s4,dobleprec;
double pendiente, umbral,tiempo;
...
sprintf(nombre3,"slope_c_med_frente_b%.2lf-%.2lf_N%d_alfa%.3f.dat",b_min,b_max,N,alfa);
escribe3=fopen(nombre3,"wt");
//escribe4=fopen("pendiente_tiempo_b1.8.dat","wt");
