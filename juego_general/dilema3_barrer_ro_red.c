...
//con la concentracion inicial de cooperantes.

       // Estadistica hecha sobre una red fija y distintas distribuciones iniciales 
//aleatorias de cooperantes
...
sprintf(nombre3,"c_med_frente_ro%.2lf-%.2lf_b%.2lf_red.dat",ro_min,ro_max,b);
 
escribe3=fopen(nombre3,"wt");   

printf("\n\n\nPrograma barrer_ro con red fija\n"); 
...
inicia_rand(time(0));
 ...
 construir_red();   //la red sera la misma a lo largo de la simulacion
