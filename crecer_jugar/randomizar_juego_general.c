...
//CORRECCION en la normalización de la prob de cambio de estrategia: diferencia máxima de coef de la matriz de payoff*max k (antes: b*k_m siempre)
...
#define nb 10     //numero de valores de b
...
int main()
{
  ...
  printf("\n\n\nPrograma juego general (RED RANDOMIZADA)\n\n"); 
