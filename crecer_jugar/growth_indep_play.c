...
// 20-5-08: desacoplo del juego y el crecimiento. ahora la prob de recibir un link es proporcional a k.  LA FITNESS NO ENTRA EN JUEGO!!??
...
*/	
	...
	for(iter=1;iter<=Niter;iter++)         //inicio bucle de estadistica
	{
		...
		//Recalculo Probabilidad de attachment dentro de la funcion nuevo_nodo()
...
// establezco el carcter del nuevo nodo:
  ...
  norma2=norma;
  P[s]=0.;             // para no enlazar el nodo actual consigo mismo
  P_prov[s]=0.;  
