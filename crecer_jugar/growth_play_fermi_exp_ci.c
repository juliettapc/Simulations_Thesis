...
//NOTA: en los archivos de la pk, representar: u 3:2  para obtener p(k)


//24-7-08 en lugar de aÒadir un intervalo de tiempo en el que solo juego, al acabar de crecer, les reasign c.i. 50% c y 50% d, y 
// las dejo evolucionar, para ver si el estado final de <c> al que se llega es igual al <c>inf o no. (copiado del growth_play_tot_ci.c de crecer_y_jugar/prob_payoff/comprobar_Cinf)
...
# define  eps    0.20     // para la prob de attachment exp de la fitness
...
int main()
{
    ...
    sprintf(file4,"%dProp-top_%d-%d-b_ini%.2lf-e%.2lf_w%.2lf_%diter_ci.dat",N,tauT,tauD,b_min,eps,seleccion,Niter);   //un solo archivo     
