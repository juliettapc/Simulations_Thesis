...
// 17-6-08: en lugar de añadir intervalo de tiempo final de juego una vez acabada de  crecer la red, una vez crecida, la randomizo y 
//les asigo c.i. 50% cooperadores y 50% defectores, y  las dejo evolucionar, 
...
int main()
{
    ...
    sprintf(file4,"%dProp-top_%d-%d-b_ini%.2lf-e%.2lf_%diter_rand_reasign.dat",N,tauT,tauD,b_min,eps,Niter);   //un solo archivo     
