...
# define jugadas_extra   20000       //despues de acabar de crecer la red y reasignar las estrategias al 50%
...
int main()
{
	...
	sprintf(file66,"%dPkc%d-%d-b%.2lf-e%.2lf_size1000_%dextra_%diter.dat",N,tauT,tauD,b,eps,jugadas_extra,Niter);      
	...
	for(iter=1;iter<=Niter;iter++)         //inicio bucle de estadistica
	{
	    ...
	    reasignar_ci();   //establezco 50% C y 50% D
