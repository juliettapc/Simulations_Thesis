...
# define p 0.006     //probabilidad de conexion de una pareja cualquiera de nodos

# define Q  150   // numero de valores distintos que puede tomar un rasgo concreto (es igual para todos los rasgos)
...
int flag=0,accion,N_links_max=0,sizes[N+1];
