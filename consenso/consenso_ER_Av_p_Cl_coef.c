...
# define Q  200   // numero de valores distintos que puede tomar un rasgo concreto (es igual para todos los rasgos)
...
//Guarda el <CC> de la GC de consenso tot y por capas
	sprintf(file9,"CC_N%d_Q%d_f%d_ER_iter%d.dat",N,Q,f,iter);
