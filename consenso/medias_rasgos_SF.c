...
# define Niter 1  //por ahora, no hago media sobre iteraciones
...
////////// CREACION DE FICHEROS  ////////////
  ...
  // sprintf(file2,"medias/Promedio_rasgos_Smax_N%d_Q%d_f%d_alfa0.0_SF_%diter.dat",N,Q,f,Niter);
  
  sprintf(file2,"medias/Promedio_rasgos_Av_p_l_vs_tpo_N%d_Q%d_f%d_alfa0.0_SF_%diter.dat",N,Q,f,Niter); 
//sprintf(file2,"medias/Promedio_rasgos_CC_vs_tpo_N%d_Q%d_f%d_alfa0.0_SF_%diter.dat",N,Q,f,Niter);
//sprintf(file2,"medias/Promedio_rasgos_N_Cl_vs_tpo_N%d_Q%d_f%d_alfa0.0_SF_%diter.dat",N,Q,f,Niter); //OJO, PARA ESTA CAMBIAN LOS PARAMETROS!!!!!!
...
//en modo "at" escribo sin borrar lo que ya este escrito
      ...
      /////////  LECTURA DEL FICHERO  ////////      
  // sprintf(file3,"Consenso_N%d_Q%d_f%d_alfa0.0_SF_iter%d.dat",N,Q,f,Niter);   
                
  sprintf(file3,"Av_path_length_N%d_Q%d_f%d_SF_iter%d.dat",N,Q,f,Niter);   

//sprintf(file3,"CC_N%d_Q%d_f%d_SF_iter%d.dat",N,Q,f,Niter);   

//sprintf(file3,"N_Clusters_N%d_Q%d_f%d_alfa0.0_SF_iter%d.dat",N,Q,f,Niter); //OJO, PARA ESTA CAMBIAN LOS PARAMETROS!!!!!!
