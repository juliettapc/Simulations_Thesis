...
////////////////////////RENORMALIZACION DE LOS TIEMPOS//////////////////////////
	...
	for(j=1;j<=lim;j++)          
	{
	    ...
	    if(M_renorm[j][2]!=0)
	    {  	   
		fprintf(fich3,"%f   %f",M_renorm[j][1],M_renorm[j][2]); 	
	    }			
	}
	if(M_renorm[j][2]!=0)
	{ 
...
//imprimo el fichero de los bines
    ...
    fprintf(fich4,"1.0    %f    %f",media_valor_final_rasgos/Niter,media_valor_final/Niter);//añado a mano el valor final en el archivo de los bines
    fclose (fich4);   
