...
//17-6-08 en lugar de añadir un intervalo de tiempo en el que solo juego, al acabar de crecer, les reasign c.i. 50% c y 50% d, y 
// las dejo evolucionar, para ver si el estado final de <c> al que se llega es igual al <c>inf o no.
...
# define  ro 0.5    // concentracion inicial de coop
# define  R 1.0
# define  Pu 0.0
# define  Su 0.0
...
int main()
{
    ...
    sprintf(file4,"%dProp-top_%d-%d-b_ini%.2lf-e%.2lf_%diter_ci.dat",N,tauT,tauD,b_min,eps,Niter);   //un solo archivo     
...
void av_path_length()
{
	...
	for(j=1;j<=cont;j++)    //el limite superior es dinamico
	{	   
