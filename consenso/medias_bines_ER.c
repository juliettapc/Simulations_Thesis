...
# define columnas  12    //que contiene el archivo de entrada ( 14 el de S_max, Av_p_l y CCoef, 12 el de Ncl )    
...
{ 
    ...
    char  file1[256],file2[256], file3[256], file4[256];
     ...
     // sprintf(file4,"medias/Bines%d_Renorm_Promedio_rasgos_Smax_vs_tpo_N%d_Q%d_f%d_ER_%diter.dat",Nbines,N,Q,f,Niter);
...
/////////  LECTURA DEL FICHERO  INICIAL////////    
	...
	// sprintf(file1,"Consenso_N%d_Q%d_f%d_ER_iter%d.dat",N,Q,f,iter);    
	//  sprintf(file1,"Av_path_length_N%d_Q%d_f%d_ER_iter%d.dat",N,Q,f,iter);   
//sprintf(file1,"CC_N%d_Q%d_f%d_ER_iter%d.dat",N,Q,f,iter);   
...
////////// CREACION DE FICHEROS INTERMEDIOS ////////////
	  ...
	  // sprintf(file2,"medias/Promedio_rasgos_Smax_vs_tpo_N%d_Q%d_f%d_ER_iter%d.dat",N,Q,f,iter);
...
//	 sprintf(file3,"medias/Renorm_Promedio_rasgos_Smax_vs_tpo_N%d_Q%d_f%d_ER_iter%d.dat",N,Q,f,iter);
